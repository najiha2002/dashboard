      ...
      // Indigo line
      {
        ...
        backgroundColor: function(context) {
          ...
          return chartAreaGradient(ctx, chartArea, [
            { stop: 0, color: adjustColorOpacity(getCssVariable('--color-paynet-green'), 0) },
            { stop: 1, color: adjustColorOpacity(getCssVariable('--color-paynet-green'), 0.2) }
          ]);
        },       
        borderColor: getCssVariable('--color-paynet-green'),
        borderWidth: 2,
        pointRadius: 0,
        pointHoverRadius: 3,
        pointBackgroundColor: getCssVariable('--color-paynet-green'),
        pointHoverBackgroundColor: getCssVariable('--color-paynet-green'),
        pointBorderWidth: 0,
