      ...
      // Indigo line
      {
        ...
        backgroundColor: function(context) {
          ...
          return chartAreaGradient(ctx, chartArea, [
            { stop: 0, color: adjustColorOpacity(getCssVariable('--color-paynet-blue'), 0) },
            { stop: 1, color: adjustColorOpacity(getCssVariable('--color-paynet-blue'), 0.2) }
          ]);
        },       
        borderColor: getCssVariable('--color-paynet-lightblue'),
        borderWidth: 2,
        pointRadius: 0,
        pointHoverRadius: 3,
        pointBackgroundColor: getCssVariable('--color-paynet-lightblue'),
