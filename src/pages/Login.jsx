...
export default function Login() {
  ...
  const handleLogin = (e) => {
    ...
    fetch('/credentials.txt')
      ...
      .then(data => {
        // Split by lines and parse as [username, password] pairs
        const credentials = data.split('\n').map(line => line.split(':'));
        // Check if entered credentials match any pair in the file
        const isValid = credentials.some(([storedUsername, storedPassword]) =>
      ...
      .catch(error => {
        ...
        setErrorMessage('Error reading credentials. Please try again later.');
      });
  };
